...
export function UserPanel({
  ...
  return (
    <div className={`w-full border-2 rounded-xl ${color} flex flex-col h-full overflow-hidden bg-white dark:bg-zinc-900`}>
      {/* Phone-style header */}
      ...
      <div className="p-2 border-b border-zinc-200 dark:border-zinc-800 flex-shrink-0 space-y-2">
        ...
        >
          ...
          {isGenerating ? "Generating..." : keyPair ? "Regenerate Keys" : "Generate Key Pair"}
        </Button>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-2 space-y-2 bg-zinc-50 dark:bg-zinc-900/50">
        ...
        {/* Empty state */}
        {chatMessages.length === 0 && !encryptedMessage && !decryptedMessage && (
